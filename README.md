...
local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/0XxVITORxX0/SPOCK-HUB/refs/heads/main/spockhub%20Gui"))()
...
local Window = Library:CreateWindow({
    ...
    LoadingEnabled = true,
    LoadingTitle = "spock hub (Blue Lock Rivals)",
    LoadingSubtitle = "by spock",
    ConfigSettings = {
        RootFolder = "spock hub", -- Added root folder for better organization
...
Window:CreateHomeTab({
    ...
    DiscordInvite = "https://discord.gg/EewSkNM6",
    Icon = 127089954578287,
})
