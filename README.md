...
local Window = Luna:CreateWindow({
    Name = "SPOCK HUB (Blue Lock Rivals)",
    Subtitle = "by ! SPOCK",
    LogoID = "71898840453598",
    LoadingEnabled = true,
    LoadingTitle = "SPOCK HUB (Blue Lock Rivals)",
    LoadingSubtitle = "BY SPCOK",
    ConfigSettings = {
        RootFolder = "SPOCKHUB", -- Added root folder for better organization
...
Window:CreateHomeTab({
    ...
    DiscordInvite = "https://discord.gg/hVJsUpAn",
    Icon = 75237883871377,
})
